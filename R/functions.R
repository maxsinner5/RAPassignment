#' Exoplanet dataset
#'@param all_exoplanets A dataframe containing all discovered exoplanets up until 2021. We only select those star systems with more than 1 planet, as they are not as dull and uninteresting.
...
#'@examples
#'exo_planets_data(all_exoplanets, num_stars, discovery_method)

exo_planets_data <- function(all_exoplanets, col1_of_interest, col2_of_interest ){
